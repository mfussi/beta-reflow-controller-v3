...
data class SetRequest(@SerializedName("temp") val temp: Float, @SerializedName("intensity") val intensity: Float)
...
data class StartRequest(
    ...
    @SerializedName("intensity") val intensity: Float? = null
)
...
data class DeleteProfileResponse(val success: Boolean, val deleted: String)
